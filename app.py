...
app.title("PROGRAMA DIGITAL DE REGISTRO DE ESTUDIANTES")
...
title = customtkinter.CTkLabel(app,text="PROGRAMA DIGITAL DE REGISTRO DE ESTUDIANTES",fg_color="white",font=("e Explosive Attack",45,"bold"),anchor="center",width=30,height=2,pady=10,text_color="purple")
...
image_fondo1 = Image.open("icons/fondo1.png")
...
image_fondo1_1 = Image.open("icons/fondo1.png")
...
image_fondo1_2 = Image.open("icons/fondo1.png")
...
image_fondo1_3 = Image.open("icons/fondo1.png")
...
image_fondo1_4 = Image.open("icons/fondo1.png")
...
image_esis = Image.open("icons/esis.png")
...
image_team = Image.open("icons/liquid1.png")
...
image_fondo2 = Image.open("icons/fondo2.png")
...
image_fondo3 = Image.open("icons/fondo3.png")
...
image_fondo4 = Image.open("icons/fondo4.png")
...
image_fondo5 = Image.open("icons/fondo5.png")
...
image_fondo6 = Image.open("icons/fondo6.png")
...
image1 = Image.open("icons/agregar1.png")
image1 = image1.resize((220, 220))
photo1 = ImageTk.PhotoImage(image1)

image2 = Image.open("icons/editar1.png")
image2 = image2.resize((210, 210))
photo2 = ImageTk.PhotoImage(image2)

image3 = Image.open("icons/eliminar1.png")
image3 = image3.resize((220, 210))
photo3 = ImageTk.PhotoImage(image3)

image4 = Image.open("icons/buscar1.png")
image4 = image4.resize((220, 220))
photo4 = ImageTk.PhotoImage(image4)

image5 = Image.open("icons/reporte1.png")
...
#botones
button1 = customtkinter.CTkButton(app, text="Agregar",font=("arial",18,"bold"), command=agregar_funcion)
button1.place(x=100,y=610)
button1 = customtkinter.CTkButton(app, text="Editar",font=("arial",18,"bold"),command=editar_funcion)
button1.place(x=410,y=610)
button1 = customtkinter.CTkButton(app, text="Eliminar",font=("arial",18,"bold"), command=eliminar_funcion)
button1.place(x=705,y=610)
button1 = customtkinter.CTkButton(app, text="Buscar",font=("arial",18,"bold"), command=buscar_funcion)
button1.place(x=995,y=610)
button1 = customtkinter.CTkButton(app, text="Generar",font=("arial",18,"bold"), command=reporte_funcion)
